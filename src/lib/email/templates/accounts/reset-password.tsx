...
export default function ResetPasswordEmail({ email, resetUrl }: Props) {
    return (
        <EmailLayout preview="Reset your Lexi password">
            <h1 style={{ fontSize: 22, margin: '0 0 12px 0' }}>Reset your password</h1>
            ...
            <section>
                ...
                <p style={{ margin: '14px 0' }}>
                    <a href={resetUrl} style={{ display: 'inline-block', background: '#1D4ED8', color: 'white', padding: '10px 16px', borderRadius: 6, textDecoration: 'none' }}>
                        Reset password
                    </a>
                </p>
