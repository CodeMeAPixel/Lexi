        ...
        <AnimatePresence>
            ...
            >
                ...
                <button
                    ...
                    className="absolute ml-3 top-1/2 right-3 transform -translate-y-1/2 text-black hover:text-red-400 transition-colors duration-200"
                    style={{
                        width: "20px",
                        height: "20px",
                        display: "flex",
                ...
                {toast.duration && toast.duration > 0 && (
                    <motion.div
                        ...
                        className="absolute bottom-0 left-0 h-1 bg-white/30 origin-left rounded-full"
                        style={{ width: "100%" }}
                    />
                )}
            </motion.div>
