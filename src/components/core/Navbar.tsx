        ...
        <div className="mt-6 border-t border-white/10 pt-4">
          {session?.user ? (
            ...
            <Link
              href="/auth"
              onClick={() => setOpen(false)}
              className="inline-flex w-full items-center justify-center gap-2 rounded-md border bg-white/[0.02]  border-white/20 px-3 py-2 text-sm font-semibold text-black transition hover:bg-white/[0.06] hover:text-white"
            >
              <HiSparkles size={14} />
