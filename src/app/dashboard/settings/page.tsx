  ...
  if (loading) {
    return (
      <main className="w-full max-w-5xl mx-auto">
        <section className="rounded-2xl border border-white/10 bg-white/[0.02] p-12">
          <h2 className="text-2xl font-semibold tracking-tight">Settings</h2>
          <p className="mt-4 text-white/55">Loading...</p>
        </section>
      </main>
    );
  }
        ...
        <Tabs tabs={["Profile", "Security"]}>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr,320px] md:flex md:flex-col items-center justify-center">
            ...
            >
              ...
              <label className="flex flex-col text-left items-left justify-left">
                <span className="mb-2 text-sm text-white/55">Username</span>
                <input
                  value={username}
              ...
              <label className="flex flex-col text-left items-left justify-left">
                <span className="mb-2 text-sm text-white/55">Biography</span>
                <textarea
                  value={bio}
            ...
            <aside className="flex flex-col items-center col-span-1 gap-4 p-4 border rounded-xl lg:items-start bg-white/[0.02] border-white/10">
              <div className="flex flex-row items-center w-full gap-6">
                  <div className="overflow-hidden border rounded-full w-36 h-36 bg-white/[0.02] border-white/10">
                  {avatarPreview ? (
                    <img
                      src={avatarPreview}
                    ...
                    <div className="flex items-center justify-center w-full h-full text-3xl text-white/45">
                ...
                <div className="flex flex-col w-full gap-2">
                  ...
                  <div className="text-xs truncate text-white/55">
                    {avatarFile?.name ??
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-white/55">View your data</span>
                <button
            ...
            {showDataPanel && (
              <div className="p-6 mt-6 border rounded-lg border-white/10 bg-black/40">
                ...
                <div className="overflow-auto max-h-[40vh] text-xs rounded border border-white/10 bg-black/60 p-4 text-left">
                  {loadingUserData ? (
                    <div>Loading…</div>
                  ) : userData ? (
                    <pre
